...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://formspree.io/f/xzzjvwdj', {
        method: 'POST',
        headers: {
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Aaron typically responds within 24-48 hours</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-blue-500 rounded-full mr-3"></div>
                  <span className="text-gray-700">Connect via LinkedIn for professional inquiries</span>
                </div>
                <div className="flex items-center">
